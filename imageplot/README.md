...
- **PCA, t-SNE, and UMAP** to visualize the full high-dimensional feature space in 2D
...
![Van Gogh Paris and Arles — t-SNE, colored by saturation](screenshots/ImagePlot_v2_van_Gogh_Paris_Arles_tSNE.png)

![Van Gogh Paris and Arles — brightness over time](screenshots/ImagePlot_v2_van_Gogh_Paris_Arles_brightness_vs_time.png)
...
![Mondrian — brightness vs. hue median](screenshots/ImagePlot_v2_Mondrian_brightness_saturation.png)
